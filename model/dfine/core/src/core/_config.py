...
class BaseConfig(object):
    ...
    def __init__(self) -> None:
        ...
        # self._lr_warmup_scheduler: _LRScheduler = None
    ...
    #     assert isinstance(m, _LRScheduler), f'{type(m)} != _LRScheduler, please check your model class'
    #     self._lr_scheduler = m

    # @property
    # def lr_warmup_scheduler(self, ) -> _LRScheduler:
