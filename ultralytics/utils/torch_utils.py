...
# 同样对 TORCHVISION_VERSION 进行 str() 转换，以防万一
TORCHVISION_0_10 = check_version(str(TORCHVISION_VERSION), "0.10.0")
TORCHVISION_0_11 = check_version(str(TORCHVISION_VERSION), "0.11.0")
TORCHVISION_0_13 = check_version(str(TORCHVISION_VERSION), "0.13.0")
TORCHVISION_0_18 = check_version(str(TORCHVISION_VERSION), "0.18.0")

if WINDOWS and check_version(str(torch.__version__), "==2.4.0"):  # reject version 2.4.0 on Windows
    LOGGER.warning(
